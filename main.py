...
# visualizing results of travel time vs study time
x_var = "G2"
style.use("ggplot")
pplot.scatter(data[x_var],data["G3"])
pplot.title("Relation between Students' Second Period Grade and Final Grade")
pplot.xlabel("Second Period Grade(#/20)")
pplot.ylabel("Final grade (#/20)")
pplot.show()

# visualizing results of travel time vs final grade
x_var = "traveltime"
style.use("ggplot")
pplot.scatter(data[x_var],data["G3"])
...
# visualizing results of study time vs final grade
x_var = "studytime"
style.use("ggplot")
pplot.scatter(data[x_var],data["G3"])
pplot.title("Relation between Students' Study Time and Final Grade")
pplot.xlabel("Study Time (hours)")
pplot.ylabel("Final grade (#/20)")
pplot.show()